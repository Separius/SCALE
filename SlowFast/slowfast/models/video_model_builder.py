...
class MViT(nn.Module):
    ...
    def __init__(self, cfg):
        super().__init__()
        # Get parameters.
        assert cfg.DATA.TRAIN_CROP_SIZE[0] == cfg.DATA.TEST_CROP_SIZE
        self.cfg = cfg
        pool_first = cfg.MVIT.POOL_FIRST
        # Prepare input.
        spatial_size = cfg.DATA.TRAIN_CROP_SIZE[0]
        temporal_size = cfg.DATA.NUM_FRAMES[0]
        ...
        self.T = cfg.DATA.NUM_FRAMES[0] // self.patch_stride[0]
        self.H = cfg.DATA.TRAIN_CROP_SIZE[0] // self.patch_stride[1]
        self.W = cfg.DATA.TRAIN_CROP_SIZE[0] // self.patch_stride[2]
        # Prepare output.
        num_classes = cfg.MODEL.NUM_CLASSES
