...
def spatial_sampling(
    ...
    if spatial_idx == -1:
        if aspect_ratio is None and scale is None:
            ...
            if detailed:
                transform_func = transform.detailed_random_resized_crop
            ...
            if detailed:
                frames, h0, w0, h1, w1 = frames
                frames, flipped = transform.detailed_horizontal_flip(0.5, frames)
...
def tensor_normalize(tensor, mean, std, func=None, dim=-1):
    """
